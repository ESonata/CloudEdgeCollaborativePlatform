    ...
    <div class="col-sm-9 col-sm-offset-3 col-md-10 col-lg-10 col-md-offset-2 main" id="main">
      ...
      <div class="row placeholders">
        <div class="col-xs-6 col-sm-3 placeholder">
          <h4>普通节点</h4>
          <span class="text-muted badge" id="book">
              <h4>${OrdinaryNodeNumber }</h4>
          </span>
        </div>
        <div class="col-xs-6 col-sm-3 placeholder">
          <h4>边缘节点</h4>
          <span class="text-muted badge" id="vote">
               <h4> ${EdgeNodeNumber}</h4>

          </span> </div>
        <div class="col-xs-6 col-sm-3 placeholder">
          <h4>容器组</h4>
          <span class="text-muted badge"  id="mark">
               <h4> 20</h4>

          </span> </div>
        <div class="col-xs-6 col-sm-3 placeholder">
          <h4>名称空间</h4>
          <span class="text-muted badge" id="order">
             <h4> 10</h4>
          </span> </div>
      </div>
      ...
      <h1 class="page-header">计算资源状态</h1>
      <div class="table-responsive">
        <table class="table table-striped table-hover">
            <thead>
                <tr>
                    <th>
                        <span class="glyphicon glyphicon-pencil"></span> <span class="visible-lg">节点名称</span>

                    </th>

                    <th>
                        <span class="glyphicon glyphicon-pencil"></span> <span class="visible-lg">状态</span>

                    </th>

                    <th>
                        <span class="glyphicon glyphicon-pencil"></span> <span class="visible-lg">节点类型</span>
      ...
      <footer>
        <h1 class="page-header">组件信息</h1>
        <div class="table-responsive">
          <table class="table table-striped table-hover">
            <tbody>
            <tr>
              <td><span style="display:inline-block; width:8em">Kubernetes版本</span> v1.17.1</td>
            </tr>
            <tr>
                <td><span style="display:inline-block; width:8em">KubeEdge版本</span> v2.0.0</td>
            </tr>
