...
<section class="container-fluid">
    ...
    <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-lg-10 col-md-offset-2 main" id="main" style="height: 100%">
            ...
            <h4 style="display: inline">边缘节点选择:</h4>
            <select id="typeBID" class="form-control" name="typeBID" onchange="getSub(this)">

                <c:forEach items="${edgeNode }" var="p">
                    <option value="${p.address}" >${p.name}</option>
                </c:forEach>
            </select>
            ...
            <script type="text/javascript">
                ...
                {
                    alert(obj.value);
                    var s="http://192.168.43.155:32030/d/9CWBz0bik/1-node-exporter-for-prometheus-dashboard-cn-v20191102shi?orgId=1&theme=light&kiosk&var-job=node-exporter&var-hostname=All&var-maxmount=%2F&var-env=&var-name=&var-node="+obj.value;
                    $("#myframe").attr("src",s);
                }

            </script>

            <iframe  id="myframe" src="http://192.168.43.155:32030/d/9CWBz0bik/1-node-exporter-for-prometheus-dashboard-cn-v20191102shi?orgId=1&theme=light&kiosk&var-job=node-exporter&var-hostname=All&var-maxmount=%2F&var-env=&var-name=&var-node=192.168.43.177:9100"  style="width:100%;height:1500px;margin-top: 2%" frameborder="0"></iframe>
