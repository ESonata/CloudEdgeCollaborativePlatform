    ...
    <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-lg-10 col-md-offset-2 main" id="main">
            ...
            <ol class="breadcrumb">
                ...
                <li>
                    <a title="查看或修改个人信息" data-toggle="modal" data-target="#addNamespace">新增命名空间</a>
                </li>

            </ol>
            <h1 class="page-header">管理命名空间 <span class="badge">${totalCount }</span></h1>
            ...
            <div class="table-responsive">
                <table class="table table-striped table-hover">
                    ...
                    <tr>
                        ...
                        <th><span class="glyphicon glyphicon-file"></span> <span class="visible-lg">空间名称</span></th>
                    ...
                    <tbody>
                    <c:forEach items="${namespaces }" var="p">
                        <tr>
                                <%--<td><input type="checkbox" class="input-control" name="checkbox[]" value="${p.ID }" /></td>--%>
                            <td class="article-title">
                                <a href="/GetDeploymentsServicesPods?namespace_name=${p.name}"> ${p.name }</a>
