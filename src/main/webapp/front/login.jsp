		...
		<div class="row">
			...
			<div class="col-md-5">
				<div
					...
					<div>&nbsp;</div>
					<form class="form-horizontal" method="post" action="/FLoginServlet">
						...
						<div class="form-group">    <div class="col-sm-offset-2 col-sm-10">       <a href="register.jsp">免费注册</a>                           <a href="backuser.jsp">找回密码</a>    </div> </div>
