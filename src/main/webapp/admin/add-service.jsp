...
<head>
    ...
    <title>新增Service - IKube云边协同管理平台</title>
            ...
            <div class="col-sm-9 col-sm-offset-3 col-md-10 col-lg-10 col-md-offset-2 main" id="main">
                <div class="row">
                    ...
                    <div class="col-md-9">
                        ...
                        <h1 class="page-header">新增Service</h1>
                        ...
                        <div class="add-article-box" style="width:49%;display: inline-block;">
                            <h2 class="add-article-box-title"><span>Service名称</span></h2>
                            <div class="add-article-box-content">
                                ...
                                <%--</c:forEach>--%>
                                <%--</select>--%>
                                <input type="text" name="service_name" placeholder="请输入Service名称" class="form-control" id="service_name" autocomplete="off">
                        ...
                        <div class="add-article-box" style="width:50%;display: inline-block;right: 1%;">
                            <h2 class="add-article-box-title"><span>Service标签键</span></h2>
                            <div class="add-article-box-content">

                                <input type="text" name="label_key"  class="form-control" id="label_key" autocomplete="off" placeholder="请输入Service标签键">
                                <span class="prompt-text">Deployment标签键</span>
                            </div>
                        </div>
                        ...
                        <div class="add-article-box" style="width:49%;display: inline-block;">
                            <h2 class="add-article-box-title"><span>Service标签值</span></h2>
                            <div class="add-article-box-content">
                                <input type="text" name="label_value"  class="form-control" autocomplete="off"  placeholder="请输入Service标签值">
                                <%--<input type="text" class="form-control" placeholder="输入现价" name="nowPrice" autocomplete="off" id="nowPrice">--%>
                                <span class="prompt-text">*Deployment标签值</span>
                        ...
                        <div class="add-article-box" style="width:50%;display: inline-block;right: 1%;">
                            ...
                            <div class="add-article-box-content">
                                ...
                                <input type="text" name="namespace_name"  class="form-control" id="namespace_name" autocomplete="off" placeholder="请输入名称空间">
                        ...
                        <div class="add-article-box" style="width:49%;display: inline-block;">
                            <h2 class="add-article-box-title"><span>访问方式</span></h2>
                            <div class="add-article-box-content">
                                <input type="text" name="type"  class="form-control" autocomplete="off"  placeholder="访问方式">
                                <%--<input type="text" class="form-control" placeholder="输入现价" name="nowPrice" autocomplete="off" id="nowPrice">--%>
                        ...
                        <div class="add-article-box" style="width:50%;display: inline-block;right: 1%;">
                            ...
                            <h2 class="add-article-box-title"><span>暴露端口名称</span></h2>
                            <div class="add-article-box-content">

                                <input type="text" name="port_name"  class="form-control" id="port_name" autocomplete="off" placeholder="请输入端口名称">
                                <span class="prompt-text">*暴露端口名称</span>
                            </div>
                        </div>
                        <div class="add-article-box" style="width:49%;display: inline-block;">
                            <h2 class="add-article-box-title"><span>端口协议</span></h2>
                            <div class="add-article-box-content">
                                <input type="text" name="port_protocol"  class="form-control" autocomplete="off"  placeholder="请输入端口协议">
                                <%--<input type="text" class="form-control" placeholder="输入现价" name="nowPrice" autocomplete="off" id="nowPrice">--%>
                                <span class="prompt-text">*端口协议</span>
                        ...
                        <div class="add-article-box" style="width:50%;display: inline-block;right: 1%;">
                            ...
                            <h2 class="add-article-box-title"><span>集群内访问端口</span></h2>
                            <div class="add-article-box-content">

                                <input type="text" name="port_port"  class="form-control" id="port_port" autocomplete="off" placeholder="请输入集群内访问端口">
                                <span class="prompt-text">*集群内访问端口</span>
                            </div>
                        </div>


                        <div class="add-article-box" style="width:49%;display: inline-block;">
                            <h2 class="add-article-box-title"><span>暴露节点端口</span></h2>
                            <div class="add-article-box-content">
                                <input type="text" name="port_nodeport"  class="form-control" autocomplete="off"  placeholder="请输入暴露节点端口">
                                <%--<input type="text" class="form-control" placeholder="输入现价" name="nowPrice" autocomplete="off" id="nowPrice">--%>
                                <span class="prompt-text">*暴露节点端口</span>
                        ...
                        <div class="add-article-box" style="width:50%;display: inline-block;right: 1%;">
                            ...
                            <div class="add-article-box-content">
                                ...
                                <input type="text" name="port_targetport"  class="form-control" id="port_targetport" autocomplete="off" placeholder="请输入容器端口">
                                <span class="prompt-text">*容器端口</span>
                            </div>
                        </div>
                        <br>
                        <br>
