...
<head>
    ...
    <title>新建DaemonSet - IKube云边协同管理平台</title>
...
<section class="container-fluid">
    ...
    <div class="row">
        ...
        <form action="/CreateDaemonSet" method="post" enctype="multipart/form-data">
            <div class="col-sm-9 col-sm-offset-3 col-md-10 col-lg-10 col-md-offset-2 main" id="main">
                <div class="row">

                    <div class="col-md-9">

                        <h1 class="page-header">新增DaemonSet</h1>
                        ...
                        <div class="add-article-box" style="width:49%;display: inline-block;">
                            <h2 class="add-article-box-title"><span>DaemonSet名称</span></h2>
                            <div class="add-article-box-content">
                                ...
                                <%--</c:forEach>--%>
                                <%--</select>--%>
                                <input type="text" name="deployment_name" placeholder="请输入Deploymnt工作负载名称" class="form-control" id="deployment_name" autocomplete="off">
                        ...
                        <div class="add-article-box" style="width:50%;display: inline-block;right: 1%;">
                            <h2 class="add-article-box-title"><span>Deployment标签键</span></h2>
                            <div class="add-article-box-content">

                                <input type="text" name="label_key"  class="form-control" id="label_key" autocomplete="off" placeholder="请输入Deployment标签键">
                        ...
                        <div class="add-article-box" style="width:49%;display: inline-block;">
                            <h2 class="add-article-box-title"><span>Deployment标签值</span></h2>
                            <div class="add-article-box-content">
                                <input type="text" name="label_value"  class="form-control" autocomplete="off"  placeholder="请输入Deployment标签值">
                        ...
                        <div class="add-article-box" style="width:50%;display: inline-block;right: 1%;">
                            ...
                            <div class="add-article-box-content">
                                ...
                                <input type="text" name="namespace_name"  class="form-control" id="namespace_name" autocomplete="off" placeholder="请输入Deployment名称空间">
                        ...
                        <%--<div class="add-article-box" style="width:49%;display: inline-block;">--%>
                            ...
                            <%--<div class="add-article-box-content">--%>
                                ...
                                <%--&lt;%&ndash;<input type="text" class="form-control" placeholder="输入现价" name="nowPrice" autocomplete="off" id="nowPrice">&ndash;%&gt;--%>
