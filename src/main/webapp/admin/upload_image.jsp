...
<title>新增镜像 - IKube云边协同管理平台</title>
...
<section class="container-fluid">
  ...
  <div class="row">
    <aside class="col-sm-3 col-md-2 col-lg-2 sidebar">
      ...
      <form action="/loadToRepository" method="post" enctype="multipart/form-data">
    <div class="col-sm-9 col-sm-offset-3 col-md-10 col-lg-10 col-md-offset-2 main" id="main">
      <div class="row">
        
          <div class="col-md-9">
          
            <h1 class="page-header">上传镜像</h1>
            ...
            <br>
              ...
              <div class="add-article-box" style="width:49%;display: inline-block;">
                  <h2 class="add-article-box-title"><span>原始镜像名称</span></h2>
                  <div class="add-article-box-content">
                      <input type="text" name="originImageName"  class="form-control" autocomplete="off"  placeholder="请输入原始镜像名称">
                      <%--<input type="text" class="originImageName-control" placeholder="输入现价" name="nowPrice" autocomplete="off" id="nowPrice">--%>
                      <span class="prompt-text">*版本号</span>
            ...
            <div class="add-article-box" style="width:49%;display: inline-block;">
              <h2 class="add-article-box-title"><span>项目名称</span></h2>
              <div class="add-article-box-content">
                <!--新增图书大类-->
                <%--<select id="typeBID" class="form-control" name="typeBID" onchange="getSub(this)">--%>
                  ...
                  <%--</c:forEach>--%>
                <%--</select>--%>
                  <input type="text" name="project" placeholder="请输入私有仓库项目名称" class="form-control" id="projeect" autocomplete="off">
                <span class="prompt-text">*项目名称</span>
              </div>
            </div>
            ...
            <div class="add-article-box" style="width:50%;display: inline-block;right: 1%;">
              <h2 class="add-article-box-title"><span>镜像名称</span></h2>
              <div class="add-article-box-content">

                  <input type="text" name="softwareName"  class="form-control" id="softwareName" autocomplete="off" placeholder="请输入镜像名称">
                  <span class="prompt-text">镜像名称</span>
              </div>
            </div>
            ...
            <div class="add-article-box" style="width:49%;display: inline-block;">
              <h2 class="add-article-box-title"><span>版本号</span></h2>
              <div class="add-article-box-content">
                  <input type="text" name="version"  class="form-control" autocomplete="off"  placeholder="请输入镜像的版本号">
            ...
            <div class="add-article-box" style="width:50%;display: inline-block;right: 1%;">
              ...
              <h2 class="add-article-box-title"><span>保存时间</span></h2>
              <div class="add-article-box-content">


                  <input style="border: none;"  class="form-control" name="create_time" type="datetime-local" value="2015-09-24T13:59:59" id="INTime"/>



                <span class="prompt-text">*保存时间</span>
              </div>
            </div>
            ...
            <%--</div>--%>
              ...
              <div class="add-article-box">
                  <h2 class="add-article-box-title"><span>保存镜像信息</span></h2>
