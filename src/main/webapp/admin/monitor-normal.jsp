...
<head>
    ...
    <title>普通节点监控 IKube云边协同管理平台</title>
    ...
    <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-lg-10 col-md-offset-2 main" id="main" style="height: 100%">
            ...
            <div class="add-article-box-content" >
                <h4 style="display: inline">普通节点选择:</h4>

                <select id="typeBID" class="form-control" name="typeBID" onchange="getSub(this)" style="display: inline">

                    <c:forEach items="${ordinaryNode }" var="p">
                        <option  value="${p.name},${p.address}" >${p.name}</option>
                    </c:forEach>
                </select>
            ...
            <script type="text/javascript">
                function getSub(obj)
                {
                    ...
                    var s="http://192.168.43.155:32030/d/200ac8fdbfbb74b39aff88118e4d1c2c1/kubernetes-compute-resources-node-pods?orgId=1&refresh=10s&theme=light&kiospk&kiosk&var-datasource=Prometheus-1&var-cluster=&var-node="+data[0];
                    var s_="http://192.168.43.155:32030/d/9CWBz0bik/1-node-exporter-for-prometheus-dashboard-cn-v20191102shi?orgId=1&theme=light&kiosk&var-job=node-exporter&var-hostname=All&var-maxmount=%2F&var-env=&var-name=&var-node="+data[1];
                    $("#myframe").attr("src",s);
                    $("#myframe_").attr("src",s_);
                }

            </script>


            <iframe  id="myframe_" src="http://192.168.43.155:32030/d/9CWBz0bik/1-node-exporter-for-prometheus-dashboard-cn-v20191102shi?orgId=1&theme=light&kiosk&var-job=node-exporter&var-hostname=All&var-maxmount=%2F&var-env=&var-name=&var-node=192.168.43.156:9100"  style="width:100%;height: 1500px;margin-top: 2%" frameborder="0"></iframe>
            <iframe  id="myframe" src="http://192.168.43.155:32030/d/200ac8fdbfbb74b39aff88118e4d1c2c1/kubernetes-compute-resources-node-pods?orgId=1&refresh=10s&theme=light&kiospk&kiosk&var-datasource=Prometheus-1&var-cluster=&var-node=${currentNormalNode}"  style="width:100%;height: 1000px;" frameborder="0"></iframe>
