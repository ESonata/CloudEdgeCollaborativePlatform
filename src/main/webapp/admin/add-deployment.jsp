...
<head>
    ...
    <title>新建Deployment - IKube云边协同管理平台</title>
...
<section class="container-fluid">
    ...
    <div class="row">
        ...
        <form action="/CreateDeployment" method="post" enctype="multipart/form-data">
            <div class="col-sm-9 col-sm-offset-3 col-md-10 col-lg-10 col-md-offset-2 main" id="main">
                <div class="row">

                    <div class="col-md-9">

                        <h1 class="page-header">新增Deployment</h1>
                        ...
                        <div class="add-article-box" style="width:49%;display: inline-block;">
                            <h2 class="add-article-box-title"><span>Deployment名称</span></h2>
